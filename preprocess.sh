...
python preprocess.py -train_src wmt14_en_fr/train.en -train_tgt wmt14_en_fr/train.fr \
   -valid_src wmt14_en_fr/val.en -valid_tgt wmt14_en_fr/val.fr -save_data data/wmt14.pt \
   -min_word_count=5

#python preprocess.py -train_src twitter/train_histories.txt -train_tgt twitter/train_responses.txt \
#   -valid_src twitter/val_histories.txt -valid_tgt twitter/val_responses.txt -save_data data/twitter.pt \
#   -min_word_count=5 -share_vocab