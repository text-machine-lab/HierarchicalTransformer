python train.py --data=cornell --model=TRANSFORMER --batch_size=32 --n_epoch=50 --eval_batch_size=32 \
...
#python train.py --data=cornell --model=HRED --batch_size=32 --n_epoch=50 --eval_batch_size=32 --tg_enable |
